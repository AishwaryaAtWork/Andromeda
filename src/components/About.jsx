...
const About = () => {
  return (
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      <p className="font-normal text-sm leading-3 text-indigo-700 hover:text-indigo-800 cursor-pointer pb-2"></p>
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12">
          <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
            We are here to provide great opportunities for you!
          </h2>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Welcome to our website! We are a team of dedicated professionals who
            are passionate about providing high-quality resources and
            opportunities for students to learn and grow. Our mission is to
            empower students with the knowledge, skills, and experiences they
            need to achieve their full potential and succeed in their chosen
            careers. On this page, you can learn more about our history, values,
            and goals, as well as the services and programs we offer to support
            student success.
          </p>
        </div>
        <div className="w-full lg:w-6/12">
      ...
      <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
        <div>
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Providing internship and career opportunities helps students gain
            practical experience, develop new skills, and build a professional
            network. This enhances their career prospects and contributes to the
            development of the future workforce. Organizations benefit from
            access to high-quality talent and support the growth of their
            industry or field.
          </p>
        </div>
        <div>
          ...
          <li className="font-normal text-base leading-6 text-gray-600 mt-6">
            Internship
          </li>
          <li className="font-normal text-base leading-6 text-gray-600 mt-6">
            Apprenticeships
        ...
        <div className="sm:block hidden">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            ...
            who are dedicated to providing the best possible service to users.
            We work collaboratively to achieve our goals and are committed to
      ...
      <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
        <div className="w-full lg:w-6/12">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
            Our mission is to provide students with access to high-quality
            internship, apprenticeship, and fellowship opportunities across
            various industries and locations. We believe that every student
            deserves the chance to gain practical experience in their chosen
            field, develop new skills, and build a professional network. By
            connecting students with top organizations and providing them with
            the resources they need to succeed, we aim to contribute to the
            development of the future workforce and support the growth of
            various industries.
          </p>
          <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">
            We are committed to promoting diversity and inclusion in all of our
            initiatives, recognizing that a diverse and inclusive workforce is
            crucial to achieving long-term success. Our team is dedicated to
            providing exceptional service and support to both students and
            organizations, ensuring that our platform is easy to use and
            tailored to their specific needs. Ultimately, our mission is to help
            students achieve their career goals and succeed in the job market.
            We are passionate about what we do and are constantly striving to
            improve and expand our offerings to better serve the needs of our
            users.
          </p>
        </div>
        <div className="w-full lg:w-6/12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                ...
                <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                  Dediacted team to provide support for the students and the
                  other communities.
                </p>
              </div>
            </div>
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                ...
                <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                  Providing a platform for the community to know about the
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                ...
                <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                  Providing newsletter information to our users.
                </p>
              </div>
            </div>
          </div>
