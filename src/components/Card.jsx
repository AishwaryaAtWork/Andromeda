...
export default function Card({internships}) {
    return (
        <>
                {internships.map((i)=>(
                    ...
                    <div className='rounded overflow-hidden shadow-lg bg-blue-400 shadow-blue-700 max-w-xs'>
                        ...
                        <div className='py-1 px-4 text-white'>
                            ...
                            <button className='bg-white hover:bg-blue-800 my-2 shadow shadow-blue-600 
                        text-blue-800 hover:text-white text-sm font-semibold px-4 py-2 rounded-md duration-500'>Learn More</button>
                        </div>
                    </div>
                </div> 
                ))}
