...
const Contact = () => {
  return (
    <section class="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px] mx-3">
      <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap lg:justify-center">
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              ...
              <p class="text-body-color mb-9 text-base leading-relaxed">
                We are thrilled to have the opportunity to serve you! Please
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-body-color text-base">
                    Vivekananda Institue of Professional Studies, Pitampura,
                    Delhi
                  </p>
                </div>
              </div>
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-body-color text-base">(+91) XXXXXXXXXX</p>
                </div>
              </div>
              <div class="mb-8 flex w-full max-w-[370px]">
                <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-body-color text-base">Vips@123.com</p>
                </div>
              </div>
            </div>
          </div>
