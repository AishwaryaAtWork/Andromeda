...
function LowerNavbar(props) {
  ...
  return (
    <>
    {/* Navbar below slider  */}
    <nav id="opportunity" className='bg-blue-500 shadow-md shadow-blue-500 border-b-2 border-b-white 
            md:flex md:items-center md:justify-between'>
        <ul className='md:flex md:items-center '>
            {/* Reanders as much as number of types available in list */}
            {opportunityType.map((types)=>(
                <li className='text-xl p-3 text-center text-white hover:bg-blue-800 duration-500 cursor-pointer'
                 key={types}
